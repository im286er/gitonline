...
class ShopModel extends Model {
	...
	public function calculateRebate($gfl=0,$type='vip'){
		if($gfl==0){
			return $type=='vip'?10:1;
		}
		if($type=='vip')
			return format_money(round($gfl/100,2));
		else
			return format_money(round(round($gfl/100,2)*C('USER_RATION_VIP'),2));
