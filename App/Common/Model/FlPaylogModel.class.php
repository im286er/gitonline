...
class FlPaylogModel extends Model {
	...
	public function promptlyRefund($refundData=array()){
		...
		$payinfo = $this->where(array('pay_oid'=>$refundData['o_id']))->find();
