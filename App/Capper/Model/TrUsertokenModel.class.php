...
class TrUsertokenModel extends Model {
	...
	//首次签署utoken
	public function sign_utoken($appid,$userid,$ucode=null,$type='inside'){
		$ucode or $ucode = randpw(4,'CHAR');
	...
	/**续签协议授权**/
	public function renew_utoken($appid,$utoken,$ucode=null,$type='inside'){
		$ucode or $ucode = randpw(4,'CHAR');
