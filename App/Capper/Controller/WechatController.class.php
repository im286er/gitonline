...
class WechatController extends Controller {
	...
	public function verifyAuth(){
		...
		$wxcodelink = $wechat::CONNECT_OAUTH_AUTHORIZE_URL.'appid='.C('WECHAT.appid').'&redirect_uri='.urlencode(U('Wechat/authLogin@tr',array(),null,false)).'&response_type=code&scope=snsapi_base&state=0#wechat_redirect';
	...
	public function authLogin(){
		$wechat = $this->wechat();
		 ...
		 $httpurl = $wechat::SNS_OAUTH_ACCESS_TOKEN_URL."appid=".C('WECHAT.appid')."&secret=".C('WECHAT.appsecret')."&code=".$code."&grant_type=authorization_code";
