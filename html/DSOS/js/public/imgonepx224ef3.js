...
function a(){
c.tap(e.love_btn,f),"function"==typeof e.comment_input_focus&&c.on(e.comment_input,"click",function(){
e.comment_input_focus();
}),c.on(e.comment_input,"input",function(){
l(e.comment_len_main);
var t=s(e.comment_input.innerText),n=g(t);
e.comment_len.innerText=n,n>140?m.addClass(e.comment_len,"warn"):m.removeClass(e.comment_len,"warn");
}),c.on(e.comment_submit_btn,"click",h,!1),c.on(e.comment_content,"click",b);
}
function l(e,t){
...
function d(){
var t=e.love_text;
t.innerText="undefined"!=typeof k.loverCount&&1*k.loverCount>0?1*k.loverCount:"赞";
}
function f(){
var t=e.love_content,o=e.love_img_content,c="1";
if(m.hasClass(t,e.love_class))m.removeClass(t,e.love_class),p(),"undefined"!=typeof k.loverCount&&(k.loverCount-=1),
c="0";else{
m.addClass(t,e.love_class);
var r=document.createElement("div");
r.innerHTML=i.render(e.love_img_tpl,{
imgurl:e.head_img_url
}),o.appendChild(r.children[0]),"undefined"!=typeof k.loverCount&&(k.loverCount+=1),
c="1";
}
return d(),n({
like:c,
...
function p(){
for(var t=e.love_img_content,n=t.children,o=0,c=n.length;c>o;o++)if(1*n[o].getAttribute("data-host")===1){
t.removeChild(n[o]);
break;
}
}
...
if(c=c||c+""=="0"?c:null,null!==c)return window.confirm("确定要删除评论？")!==!0?!1:(k.comment_deleting=!0,
r({
type:"POST",
...
error:function(){
alert("系统繁忙，请稍后再试"),k.comment_deleting=!1;
}
}),!1);
}
}
...
switch(1*t.base_resp.ret){
case 0:
e.comment_input.blur(),setTimeout(function(){
e.toast_content.innerText="已评论",l(e.comment_toast);
},50),setTimeout(function(){
u(e.comment_toast),T(t),e.comment_input.innerText="",e.comment_len.innerText=0,m.removeClass(e.comment_len,"warn"),
"function"==typeof e.comment_submit_callback&&e.comment_submit_callback(t),k.addComment=!0,
k.commenting=!1;
},1500);
break;
...
});define("pages/version4video.js",["biz_common/dom/event.js","biz_wap/jsapi/core.js"],function(i){
"use strict";
function e(){
return document.domain="qq.com",top.window.__appmsgCgiData.can_use_page&&(a.is_ios||a.is_android)?!0:!1;
}
function n(){
return!0;
}
...
var s=i("biz_common/dom/event.js"),r=i("biz_wap/jsapi/core.js"),d={
music_support:"addEventListener"in window,
networkType:""
},a={};
return function(i){
a.is_ios=/(iPhone|iPad|iPod|iOS)/i.test(i),a.is_android=/(Android)/i.test(i),a.is_android_phone=!!a.is_android&&/Mobile/i.test(i),
a.is_android_tablet=!!a.is_android&&!/Mobile/i.test(i),a.ipad=/iPad/i.test(i),a.iphone=!a.ipad&&/iPhone\sOS/i.test(i),
a.is_wp=/Windows\sPhone/i.test(i),a.is_pc=!a.is_wp&&/Windows|Mac\sOS/i.test(i),a.inWechat=/MicroMessenger/.test(i),
s.on(window,"load",function(){
if(""==d.networkType&&a.inWechat){
var i={
...
r.invoke("getNetworkType",{},function(e){
