//先要加载接口，要在函数外，保证先加载
document.write('<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=0Fafcd0a5385f509b005594a4de38114"></script>');
...
function ShowMap(objname,options){
	...
	//设定初始坐标
	var point=new BMap.Point(120.127912,30.343318);
	//范围为3-18级
	var zoom=this._zoom;
	...
	if (this._ismove=="1"){
		...
		var label = new BMap.Label("可拖拽，请最大化后标注",{offset:new BMap.Size(20,-15)});
...
function sear(result){//地图搜索
	ShowMap("map1",{addr:result,ismove:'1',piobj:'coordinates'});
}
