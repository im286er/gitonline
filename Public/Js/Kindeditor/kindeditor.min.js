...
(function (window, undefined) {
	...
	var _VERSION = '4.1.7 (2013-04-21)',
		...
		_IE = window.ActiveXObject ? true : false,
...
_extend(KDialog, KWidget, {
	init : function(options) {
		...
		bodyDiv.append(body);
		//bodyDiv.append('<div>温馨提示：图片大小不超过200K， 图片格式为 jpg,png</div>');//后期加
	...
	showLoading : function(msg) {
		...
		var _mtp = Math.round(body.height() / 3);
		self.loading = K('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-content" style="margin-top:'+ _mtp +'px;">' + msg + '</div></div>').width(body.width()).height(body.height()).css('top', self.headerDiv.height() + 'px');
...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function bindEvent(el, result, data, createFunc) {
			var fileUrl = K.formatUrl(result.current_url + data.filename, 'absolute', self.imageBaseUrl),
...
KindEditor.plugin('insertfile', function(K) {
	...
	self.plugin.fileDialog = function(options) {
		...
		var html = [
			'<div style="padding:20px;">',
			'<div class="ke-dialog-row">',
			'<label for="keUrl" style="width:60px;">应用地址</label>',
