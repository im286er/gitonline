...
!function (a) {
    ...
    c.addInterceptor(function (a, b, c) {
        ...
        if (a.properties && a.properties.children) {
            var c = 320, d = a.css.width || c - parseInt(a.css.left), e = a.css.height || d / 2, 
...
//                }})
        ...
        if (a = $("button", a)[0], "view" == c.mode) {
            var d = function (b, c) {
                ...
                }), d && $.ajax({cache: !0, type: "POST", url: PREFIX_HOST + "?g=Merchant&c=Specialview&a=adduser&id=" + c, data: $.param(f), async: !1, error: function (a) {
                    alert("Connection error")
                }, success: function (a) {
...
!function ($) {
    ...
    function parseJson(a) {
		...
		$("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由品艺场景秀免费移动场景应用自营销管家提供技术支持"), $(".scene_title").html(a.obj.name), pageMode = a.obj.pageMode;
        var b = [];
        return a.obj.property && (a.obj.property = JSON.parse(a.obj.property)), 
		b = a.list, b.length <= 0 ? (alert("此场景不存在!"), void(window.location.href = "http://scene.pywork.com")) : (appendLastPage(a, b), void bindShare(a))
    }
    ...
    function parsePage(a, b) {
        ...
        }(f) : a[f - 1].properties.finger ? (c.push({num: f, finger: a[f - 1].properties.finger}), d || (d = !0, $.getScript("/Public/Yqx/static/css_o/lock_effect.js", function (b, d, f) {
        ...
        if (a.obj.createTime > 14165028e5 && 1==2)if (a.obj.image.hideEqAd)parsePage(b, a); else if (a.obj.image.isAdvancedUser) {
            ...
            a.obj.property && a.obj.property.bottomLabel && a.obj.property.bottomLabel.id ? $.ajax({type: "GET", url: PREFIX_S1_URL + "eqs/pageTpl/" + a.obj.property.bottomLabel.id, xhrFields: {withCredentials: !0}, crossDomain: !0, success: function (c) {
                ...
                for (d.length; e < d.length; e++) {
                    var f = d[e];
                    if (f.sceneId = a.obj.id, f.pageId = b[b.length - 1].id, a.obj.property.bottomLabel.name && a.obj.property.bottomLabel.url && "http://" != a.obj.property.bottomLabel.url)2 == f.type && f.content.indexOf("scene.pywork.com科技公司") > 0 && (f.content = f.content.replace(/scene.pywork.com科技公司/, '<a href="http://kf.scene.pywork.com:9092/eqs/link?id=' + a.obj.id + "&amp;url=" + encodeURIComponent(a.obj.property.bottomLabel.url) + '" target=_blank>' + a.obj.property.bottomLabel.name + "</a>")); else if (a.obj.property.bottomLabel.name)2 == f.type && f.content.indexOf("scene.pywork.com科技公司") > 0 && (f.content = f.content.replace(/scene.pywork.com科技公司/, a.obj.property.bottomLabel.name)); else if (/品艺场景秀技术支持/.test(f.content)) {
    ...
    if (param.indexOf("preview=preview") > 0 && (preview = !0), param.indexOf("branchid=") > 0 && (branchid = param.substring(param.indexOf("branchid=") + 9)), param.indexOf("mobileview=mobileview") > 0 && (mobileview = !0), isWeixin() && bindWeixin(), !mobilecheck()) {
		...
		*/
		var addElmentsForPc = function (a) {
            ...
            c.href = "/Public/Yqx/static/css/pcviewer.css", 
			c.rel = "stylesheet", b.appendChild(c), 
			window != window.top ? $("body").css("background-image", "none") : ($.getScript("/Public/Yqx/static/js/qrcode.js", function () {
                $.getScript("/Public/Yqx/static/js/jquery.qrcode.js", function () {
                  //  $("#con").before('<div id="code"><div>扫一扫，分享给朋友！</div><div style="text-align: center;background:#fff;padding: 10px;" id="codeImg"/><div id="view_share" class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a></div><div id="view_reg">这么漂亮的场景&nbsp;→<span><a target="_blank" href="http://scene.pywork.com">我也来制作</a></span></div><div id="support">技术支持 BY <a target="_blank" href="http://scene.pywork.com"><img id="logoSmall" src="/Public/Yqx/static/images/bg_small.png"/></a></div></div>'), $("#codeImg").qrcode({render: "canvas", width: 200, height: 200, text: PREFIX_URL + "v/" + a + "?ewmcode=1"})
                })
            })
